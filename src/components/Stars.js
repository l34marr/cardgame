...
const Stars = () => {
    return (
            <svg className={starsStyles.svgContainer} xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" viewBox="218.8 226.8 258.4 258.3">
                <clippath id="bg">
                    <circle cx="348" cy="356" r="129.2"/>
                </clippath>
                <g className={starsStyles.stars} clip-path="url(#bg)">
                    <circle className={starsStyles.starsBg} fill="#3079AB" stroke="#95C7E8" stroke-width="6" stroke-linecap="round" cx="348" cy="356" r="129.2"/>
                    <path className={starsStyles.star} id="star-medium" opacity="0.75" fill="#FFFFFF" d="M409.7,337.4c-1.2-1-2.2-1.2-8.4-1c-3,0-6.9,0.2-11.9,0.5c-5.7,0.2-11.4,0.7-14.6,1
                    ...
                    <path className={starsStyles.star} id="star-large" opacity="0.6" fill="#FFFFFF" d="M310.3,334.7c-0.5-0.7-1-1.2-4-2.5c-1.5-0.7-3.5-1.5-6.2-2.5
                    ...
                    <path class={starsStyles.star} id="star-small" opacity="0.4" fill="#FFFFFF" d="M446.1,360.4c-0.5-0.2-0.7-0.2-3-0.2c-1,0-2.5,0.2-4.2,0.5
